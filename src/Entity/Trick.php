...
class Trick
{
    ...
    /** @var string|null the trick name */
    ...
    /** @var string|null the trick slug */
    #[ORM\Column(length: 255)]
    private ?string $slug = null;

    /** @var string|null the trick description */
    ...
    /** @var DateTimeImmutable|null the trick creation date */
    #[ORM\Column]
    ...
    /** @var User|null the trick author */
